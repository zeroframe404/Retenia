...
describe('domain vocabulary parity', () => {
  ...
  > = [
    ...
    [
      ...
      core.DIAGNOSTIC_SESSION_STATUSES,
      schema.DIAGNOSTIC_SESSION_STATUSES,
    ],
    ['DIAGNOSTIC_ENTRIES', core.DIAGNOSTIC_ENTRIES, schema.DIAGNOSTIC_ENTRIES],
    ['DIAGNOSTIC_STOP_REASONS', core.DIAGNOSTIC_STOP_REASONS, schema.DIAGNOSTIC_STOP_REASONS],
    ['REMEDIATION_TRIGGERS', core.REMEDIATION_TRIGGERS, schema.REMEDIATION_TRIGGERS],
    ['REMEDIATION_STATUSES', core.REMEDIATION_STATUSES, schema.REMEDIATION_STATUSES],
    ['REMEDIATION_REFUSALS', core.REMEDIATION_REFUSALS, schema.REMEDIATION_REFUSALS],
