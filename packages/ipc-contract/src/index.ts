...
export {
  ...
  diagnosticEntryDtoSchema,
  diagnosticItemDtoSchema,
  diagnosticModuleResultDtoSchema,
  diagnosticModuleStatusDtoSchema,
  diagnosticResultDtoSchema,
  diagnosticSectionDtoSchema,
  diagnosticStateDtoSchema,
  diagnosticStopReasonDtoSchema,
